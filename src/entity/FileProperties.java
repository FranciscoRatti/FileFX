...
public class FileProperties extends File{
    public FileProperties(
        ...
        FileProperties.ownerPermissions=ownerPermissions;
        FileProperties.groupPermissions=groupPermissions;
        FileProperties.otherPermissions=otherPermissions;
        FileProperties.owner=owner;
        FileProperties.group=group;
        FileProperties.size=size;
        FileProperties.dateTime=dateTime;
    }
    ...
    public static void setOwnerPermissions(char[] ownerPermissions) {
        FileProperties.ownerPermissions = ownerPermissions;}

    public static char[] getGroupPermissions() {return groupPermissions;}
    public static void setGroupPermissions(char[] groupPermissions) {
        FileProperties.groupPermissions = groupPermissions;}

    public static char[] getOtherPermissions() {return otherPermissions;}
    public static void setOtherPermissions(char[] otherPermissions) {
        FileProperties.otherPermissions = otherPermissions;}
